...
for i in range(len(FileList)):
    ...
    # r1 = r2_score(df_list[i]['bxs2'], df_list[i]['1_predict'])
    # MSE1 = mean_squared_error(df_list[i]['bxs2'], df_list[i]['1_predict'])
    R1.append(r1)
df_r['Model1'] = R1
...
# print(df_list[0])
# print(r2_score(df_list[0]['bxs2'], df_list[0]['1_predict']))
